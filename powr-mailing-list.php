<?php
    ...
    Description: Create a custom Mailing List Signup Form in minutes. Add the widget to your theme, or create a Mailing List on ANY page or post by using the shortcode [powr-mailing-list]. Then, simply visit your site and click the settings icon to customize your Mailing List right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.0
